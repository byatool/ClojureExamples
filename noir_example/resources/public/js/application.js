...
var src_cljs = {src:{}};
src_cljs.src.noir_example = {};
src_cljs.src.noir_example.event = {};
src_cljs.src.noir_example.event.set_click = function(a, b) {
  return goog.events.listen(a, goog.events.EventType.CLICK, b)
};
goog.exportSymbol("src_cljs.src.noir_example.event.set_click", src_cljs.src.noir_example.event.set_click);
src_cljs.src.noir_example.some_page = {};
src_cljs.src.noir_example.some_page.set_button = function(a) {
  a = goog.dom.getElement(a);
  return src_cljs.src.noir_example.event.set_click.call(null, a, function() {
    return alert("hihi")
  })
};
